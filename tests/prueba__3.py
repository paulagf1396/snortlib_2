...
class prueba__3(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'snortlib_2': snortlib_2.SnortLib2}

    def __init__(self, *args, **kwargs):
        super(prueba__3, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
	...
	mensaje = parser.OFPFlowMod(datapath=datapath, match=parser.OFPMatch(in_port=1), instructions=[parser.OFPInstructionActions(ofproto_v1_3.OFPIT_APPLY_ACTIONS, actions)]) 
