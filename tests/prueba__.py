...
class prueba__(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'snortlib_2': snortlib_2.SnortLib2}

    def __init__(self, *args, **kwargs):
        super(prueba__, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
	...
	mensaje = parser.OFPPacketOut(datapath=datapath, in_port=1, actions=[parser.OFPActionOutput(2)])
	...
	print
	print 'Acciones del mensaje'
	
	for action in mensaje.actions:
		print(action)
